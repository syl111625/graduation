        ...
        xAxis : [
            {
                ...
                data : ['2017-10-10','2017-10-12','2017-10-14','2017-10-16','2017-10-12','2017-10-14','2017-10-16']
//              dada:[]
            }
        ],
        yAxis : [             //为什么设置不到双y轴
        ...
        series : [
            {
                name:'用电量',
                type:'bar',
                data:[200, 150, 400, 100, 150, 40, 100],
                barWidth:25,
                markPoint : {
                    data : [
                        {type : 'max', name: '最大值'},
            ...
            },
            {
                name:'功率',
                type:'bar',
                data:[100,120,150, 120, 150, 40, 100],
                barWidth:25,
                markPoint : {
                    data : [
                        {type : 'max', name: '最大值'},
...
(function () {
    var lineChart = echarts.init(document.getElementById("echarts-line-chartDefined"));
    var lineoption = {
        title : {
            text: '一周能耗分析'
        },
